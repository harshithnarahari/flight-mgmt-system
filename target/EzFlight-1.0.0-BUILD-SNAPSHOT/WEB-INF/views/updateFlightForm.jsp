...
<c:choose>
	...
	<form method="POST" action="manageFlight.htm?action=updateFlight">
		Flight Name:
		<input type="text" name="flightName" value=${requestScope.flight.flightName} id="flightName" onblur="checkFName()" onClick="clearfield()">
		<input type="hidden" name="flightNumber" value=${requestScope.flight.flight_no}  />
		Date
		<input type="date" name="date" value=${requestScope.flight.date} id="date" onblur="checkDateAndTime()" onClick="clearfield()">
		Time
		<input type="time" name="time" value=${requestScope.flight.time} id="time" onblur="checkDateAndTime()" onClick="clearfield()">
		Total Seats: <input type="number" value=${requestScope.flight.totalSeats}  id="totalSeats" name="totalSeats" onblur="checkSeats()" /><br>
        Ticket Price: <input type="number" value=${requestScope.flight.amount} id="amount" name="amount" onblur="checkPrice()" />
