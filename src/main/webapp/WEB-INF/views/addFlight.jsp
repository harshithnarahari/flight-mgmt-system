...
function GetXmlHttpObject()
{
	...
	<form:form modelAttribute ="flight" method="POST" action="manageFlight.htm?action=submit">
           Flight Number: <form:input type="number" path="flight_no"  id="flightNumber" onblur="checkFlightNumber()" onClick="clearErr()"/><br><br>
            Flight Name:<form:input type="text" path="flightName"  id="flightName"  onblur="checkFlightName()" onClick="clearErr()"/><br><br>
            Total Seats: <form:input type="number" path="totalSeats"  id="totalSeats" onClick="check()"  /><br><br>
